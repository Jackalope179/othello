...
class Reversi:
    ...
    def __init__(self, single_player=False, difficulty_ = 0, mode_ =""):
    ...
    def game_info(self):
        ...
        if(self.mode == "AI"):
            if int(self.difficulty[0]) == 1:
                self.mode1 = "Corner"
            elif int(self.difficulty[0]) ==2:
                self.mode1 = "Stability"
            elif int(self.difficulty[0]) == 3:
                self.mode1 = "Mobility"
            else:
                self.mode1 = "Coin Parity"  
            
            if int(self.difficulty[1]) == 1:
                self.mode2 = "Corner"
            elif int(self.difficulty[1]) ==2:
                self.mode2 = "Stability"
            elif int(self.difficulty[1]) == 3:
                self.mode2 = "Mobility"
            else:
                self.mode2 = "Coin Parity"  
